...
export default function Upload() {
    ...
    const handleUploadRequest = e => {
        ...
        if (!agreed) {
            setWarning('You must agree to the terms of service and privacy policy!');
            return;
        }
        if (title.length === 0) {
            ...
            <form onSubmit={handleUploadRequest}>
                ...
                <div className='group' style={{ marginTop: '2rem' }}>
                    <div className='flex-row align-center' style={{ margin: '0 auto' }}>
                        ...
                        <p>I agree to the <a href='#/upload'>terms of service</a> and <a href='#/upload'>privacy policy</a>.</p>
                    </div>
                </div>
                <div className='group'>
